...
sftp = ssh.open_sftp()
local_path = r"C:\Users\ismail\.gemini\antigravity-ide\brain\07d4f59a-aa32-4405-a210-1e8cd4263536\scratch\vps_signals.csv"

# Check if file exists on VPS
try:
    sftp.get("/root/crypto/export_app_data/signals_tracker_history.csv", local_path)
    print("Downloaded /root/crypto/export_app_data/signals_tracker_history.csv successfully!")
