...
🔗 https://bullsandbears.binaryunit.tech`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg rounded-2xl bg-dark-950 border border-slate-800 shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-800/80 px-5 py-3.5 bg-dark-900/80">
          <div className="flex items-center gap-2">
            <Share2 className="h-4 w-4 text-cyan-400" />
            <h3 className="text-sm font-black text-white">Export & Share Institutional Signal</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5">
          <div
            ref={cardRef}
            className="relative rounded-2xl bg-gradient-to-br from-dark-900 via-dark-950 to-dark-900 p-5 border border-cyan-500/30 shadow-xl overflow-hidden"
          >
            ...
            <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
              ...
              <span className="rounded-full bg-cyan-950 px-2.5 py-0.5 text-[10px] font-bold text-cyan-300 border border-cyan-700/50">
                💎 {grade}
              </span>
            </div>
            ...
            <div className="mt-3.5 flex items-center justify-between">
              <div>
                <h4 className="text-2xl font-black text-white">{symbol}</h4>
            ...
            <div className="mt-3.5 flex items-center justify-between text-[10px] font-mono text-slate-400 border-t border-slate-800/60 pt-2">
              ...
              <span className="text-cyan-400 font-bold">bullsandbears.binaryunit.tech</span>
            </div>
          </div>
          ...
          <div className="mt-4 flex items-center gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-cyan-600 px-4 py-2.5 text-xs font-bold text-white hover:bg-cyan-500 transition-all shadow-lg shadow-cyan-500/20"
            >
            ...
            <button
              onClick={handleCopyTelegram}
              className="flex items-center gap-1.5 rounded-xl bg-dark-900 px-3.5 py-2.5 text-xs font-semibold text-slate-300 border border-slate-800 hover:bg-slate-800 transition-all"
            >
