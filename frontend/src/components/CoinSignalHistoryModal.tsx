        ...
        <div className="relative w-full max-w-5xl xl:max-w-6xl max-h-[90vh] sm:max-h-[88vh] flex flex-col rounded-2xl bg-dark-950 border border-slate-700/80 shadow-2xl shadow-cyan-950/60 overflow-hidden transform animate-in zoom-in-95 duration-200 my-0">
          ...
          <div className="flex items-center justify-between border-b border-slate-800/80 px-4 sm:px-6 py-3.5 bg-dark-900/95 backdrop-blur-md shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1 rounded-xl bg-dark-950 p-1 border border-slate-800">
                <button
              ...
              {latestSignal && (
                <button
                  ...
                  className="hidden md:flex items-center gap-1.5 rounded-xl bg-cyan-950/80 px-3 py-1.5 text-xs font-bold text-cyan-300 border border-cyan-700/60 hover:bg-cyan-900 transition-colors shadow-sm"
                >
              ...
              <button
                onClick={onClose}
                className="rounded-xl p-2 text-slate-400 hover:text-white hover:bg-slate-800/80 transition-colors ml-1"
                title="Close (Esc)"
              >
                <X className="h-5 w-5" />
              </button>
          ...
          {/* 2. Top Stats Ribbon */}
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 sm:gap-3 p-3 sm:px-6 bg-dark-900/60 border-b border-slate-800 shrink-0">
            <div className="rounded-xl bg-dark-950/80 p-2.5 sm:p-3 border border-slate-800">
              <span className="text-[10px] uppercase font-bold text-slate-400">Total Logged</span>
              <p className="text-base sm:text-lg font-black text-white">{total}</p>
            </div>
            <div className="rounded-xl bg-emerald-950/30 p-2.5 sm:p-3 border border-emerald-500/30">
              <span className="text-[10px] uppercase font-bold text-emerald-400">Won (Green)</span>
              <p className="text-base sm:text-lg font-black text-emerald-400">{wonCount}</p>
            </div>
            <div className="rounded-xl bg-rose-950/30 p-2.5 sm:p-3 border border-rose-500/30">
              <span className="text-[10px] uppercase font-bold text-rose-400">Lost (Red)</span>
              <p className="text-base sm:text-lg font-black text-rose-400">{lostCount}</p>
            </div>
            <div className="rounded-xl bg-blue-950/30 p-2.5 sm:p-3 border border-blue-500/30">
              <span className="text-[10px] uppercase font-bold text-blue-400">Pending (Blue)</span>
              <p className="text-base sm:text-lg font-black text-blue-400">{pendingCount}</p>
            </div>
            <div className="rounded-xl bg-dark-950/80 p-2.5 sm:p-3 border border-slate-800 col-span-2 sm:col-span-1">
              <span className="text-[10px] uppercase font-bold text-cyan-400">Decisive Win Rate</span>
              <p className="text-base sm:text-lg font-black text-white">{winRate}%</p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="sticky top-0 z-10 flex flex-wrap items-center justify-between gap-3 px-4 sm:px-6 py-2.5 bg-dark-950/95 backdrop-blur-md border-b border-slate-800">
                  ...
                  <select
                    ...
                    className="rounded-xl bg-dark-900 px-3 py-1 text-xs text-slate-300 border border-slate-800 focus:border-cyan-500 focus:outline-none font-mono"
                  >
