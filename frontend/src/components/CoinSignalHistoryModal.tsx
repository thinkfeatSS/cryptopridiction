...
export default function CoinSignalHistoryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 sm:p-6 animate-in fade-in duration-200">
      <div className="relative w-full max-w-6xl max-h-[90vh] flex flex-col rounded-2xl bg-dark-950 border border-slate-800 shadow-2xl shadow-cyan-500/10 overflow-hidden">
        {/* Header */}
        ...
        {/* Stats Ribbon */}
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 p-4 bg-dark-900/40 border-b border-slate-800">
